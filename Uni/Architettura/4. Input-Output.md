...
### Approfondimento sul DMA[](https://likingaxis.github.io/UNI/UNI/ARCHITETTURA/LEZIONI/4.Input-Output#approfondimento-sul-dma)
...
>Immagina che il monitor sia una matrice e che in base a riga e colonna tu devi distribuire dei bit che corrispondono a una informazione su schermo per collegare la GPU alla CPU usiamo un bus chiamato AGP oppure PCIe
