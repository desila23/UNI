...
- ***CS*** : collega più PIO in parallelo
- ***A0-A1***: comunica con il bus indirizzi per scegliere l’informazione
- ***WR*** : si asserisce quando la CPU ha emesso i dati sul bus e sono validi per la scrittura
- ***RD*** : si asserisce quando la CPU effettua una lettura dal bus dati
