...
![[Pasted image 20240416185114.png]]
Dove:
...
- $OP_2$ è i secondo operando, che può essere un valore immediato, un altro registro o un'operazione di shift su un valore o su un registro
