...
- ***{S}*** (opzionale) forza la scrittura nel registro di stato CPSR
...
Il valore sarebbe 0x00000081, ma non abbiamo i bit necessari. L'assemblatore memorizza all'interno dell'istruzione la coppia di valori <$1000_2$, $10000001_2$> (8, 81), e quindi vuol dire che io farò 13 balzi (le frecce a sinistra) di due bit ognuno.
